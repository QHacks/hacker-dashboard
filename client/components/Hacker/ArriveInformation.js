...
export default () => (
    <div>
        <Segment>
            ...
            <p>Yay! Its confirmed, you're coming to QHacks 2018. Now, what can you do in the meantime? Start thinking
            ...
            <p>As outlined in your acceptance email we have buses traveling from Toronto, Waterloo, Montreal and Ottawa.
                In order to reserve a spot on one of the buses, you must email <a href="mailto:travel@qhacks.io">travel@qhacks.io</a>.
                The buses will be filled on a first-come-first-serve basis, so make sure to send us an email as soon as
                possible.</p>

            <p>If you are travelling to QHacks from another location than the ones listed above, we will be offering
