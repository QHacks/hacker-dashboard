...
const EMAIL_TEMPLATES = {
  ...
  [EMAIL_STRINGS.TEMPLATES.APPLICATION_ACCEPTED_FROM_WAITLIST.NAME]: {
    createMessage: prepareTemplate({
      ...
      subject:
        EMAIL_STRINGS.TEMPLATES.APPLICATION_ACCEPTED_FROM_WAITLIST.SUBJECT,
      from: EMAIL_STRINGS.EMAIL_ADDRESSES.QHACKS_HELLO
    })
  },
  ...
  [EMAIL_STRINGS.TEMPLATES.APPLICATION_ACCEPTED_REMINDER_AFTER_WAITLIST_ACCEPTED
    ...
    createMessage: prepareTemplate({
      ...
      text:
        EMAIL_STRINGS.TEMPLATES
          .APPLICATION_ACCEPTED_REMINDER_AFTER_WAITLIST_ACCEPTED.TEXT,
      subject:
        EMAIL_STRINGS.TEMPLATES
          .APPLICATION_ACCEPTED_REMINDER_AFTER_WAITLIST_ACCEPTED.SUBJECT,
      from: EMAIL_STRINGS.EMAIL_ADDRESSES.QHACKS_HELLO
    })
  },
