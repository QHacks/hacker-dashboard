      ...
      <Item.Group>
        <Item>
          ...
          <Item.Content verticalAlign="middle">
            <Item.Header
              as="a"
              href="https://join.slack.com/t/qhacks2018/shared_invite/enQtMzAwNTkyNTU3NjY1LWExOTkzZmNiODNiNGM4MDZhOTMzNjM3MWYxMjdhZmZhZmZiNzEwODAzY2U2MDM2YzE0YzgwM2UxZWQyZmM2NTE"
            >
              Join the QHacks 2018 Slack!
            </Item.Header>
            <Item.Description>
              This will be the primary method our team (and our partners) will
              communicate with you before and during the event! Make sure to
              join to stay up to date.
            </Item.Description>
          </Item.Content>
        </Item>
        <Item>
          ...
          <Item.Content verticalAlign="middle">
            <Item.Header as="a" href="https://qhacks2018.devpost.com/">
              Check out the QHacks 2018 Devpost!
            </Item.Header>
            <Item.Description>
              Devpost is where you will submit your projects at the end of the
              weekend. More information like prizes, judges and our partners
        ...
        <Item>
          ...
          <Item.Content verticalAlign="middle">
            <Item.Header as="a" href="https://twitter.com/qhacks18?lang=en">
              Follow QHacks on Twitter for giveaways!
            </Item.Header>
            <Item.Description>
              We will be having giveaways on Twitter before and during the
              event, so make sure you give us a follow. You won't want to miss
              out!
            </Item.Description>
          </Item.Content>
        </Item>
