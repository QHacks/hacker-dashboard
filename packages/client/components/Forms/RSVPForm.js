...
class RSVPForm extends Component {
  ...
  renderWithdrawTrigger() {
    return <Button content="Withdraw Application" secondary type="button" />;
  }
  ...
  render() {
    return <div className="rsvp-form-container">{this.renderRSVPForm()}</div>;
  }
}
