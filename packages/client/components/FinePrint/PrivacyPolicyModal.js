    ...
    >
      ...
      >
        ...
        <p>
          ...
          media profiles, Date of birth, phone/mobile number.
        </p>
        ...
        <p>
          ...
          interests, you give us consent to do so for a specific purpose (for
          example, you might consent to us sending you our newsletter), or we
          need to process your data to comply with a legal obligation.
        </p>
        <p>
        ...
        <p>
          ...
          manner that is incompatible with these purposes: to enable you to
          customise or personalise your experience of our website, to enable you
          to access and use our website, associated applications and associated
          social media platforms;to contact and communicate with you, for
          internal record keeping and administrative purposes;for analytics,
          market research and business development, including to operate and
          improve our website, associated applications and associated social
          media platforms, to run competitions and/or offer additional benefits
          to you, for advertising and marketing, including to send you
          ...
          you, to comply with our legal obligations and resolve any disputes
          that we may have, and to consider your employment application.
        </p>
        ...
        <p>
          ...
          operators;our employees, contractors and/or related entities; and,
        ...
        <p>
          <strong>QHacks Data Controller</strong>
          <br />
          Vinith Suriyakumar
          <br />
          vinith@qhacks.io
        ...
        <p>
          <strong>QHacks Data Protection Officer</strong>
          <br />
          Vinith Suriyakumar
          <br />
          vinith@qhacks.io
