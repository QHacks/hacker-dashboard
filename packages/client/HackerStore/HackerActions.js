...
const APPLICATIONS_WITH_REVIEWS_COUNT_ENDPOINT =
  '/admin/applications/reviewed/count';
...
const apiRequestTypes = {
  ...
  FETCH_APPLICATIONS_WITH_REVIEWS_COUNT:
    '@@/hacker/FETCH_APPLICATIONS_WITH_REVIEWS_COUNT',
  FETCH_EMAILS: '@@/hacker/FETCH_EMAILS',
  FETCH_HACKERS_REQUIRING_CHECK_IN:
    '@@/hacker/FETCH_HACKERS_REQUIRING_CHECK_IN',
...
const apiSuccessTypes = {
  ...
  APPLICATIONS_WITH_REVIEWS_FETCHED:
    '@@/hacker/APPLICATIONS_WITH_REVIEWS_FETCHED',
  APPLICATIONS_WITH_REVIEWS_COUNT_FETCHED:
    '@@/hacker/APPLICATIONS_WITH_REVIEWS_COUNT_FETCHED',
  EMAILS_FETCHED: '@@/hacker/EMAILS_FETCHED',
  HACKERS_REQUIRING_CHECK_IN_FETCHED:
    '@@/hacker/HACKERS_REQUIRING_CHECK_IN_FETCHED',
...
const apiErrorTypes = {
  ...
  APPLICATION_TO_REVIEW_FETCH_ERROR:
    '@@/hacker/APPLICATION_TO_REVIEW_FETCH_ERROR',
  SETTINGS_FETCH_ERROR: '@@/hacker/SETTINGS_FETCH_ERROR',
  REVIEWERS_FETCH_ERROR: '@@/hacker/REVIEWERS_FETCH_ERROR',
  APPLICATIONS_WITH_REVIEWS_FETCH_ERROR:
    '@@/hacker/APPLICATIONS_WITH_REVIEWS_FETCH_ERROR',
  APPLICATIONS_WITH_REVIEWS_COUNT_FETCH_ERROR:
    '@@/hacker/APPLICATIONS_WITH_REVIEWS_COUNT_FETCH_ERROR',
  EMAILS_FETCH_ERROR: '@@/hacker/EMAILS_FETCH_ERROR',
  HACKERS_REQUIRING_CHECK_IN_FETCH_ERROR:
    '@@/hacker/HACKERS_REQUIRING_CHECK_IN_FETCH_ERROR',
  ...
  HACKER_CHECK_IN_STATUS_UPDATE_ERROR:
    '@@/hacker/HACKER_CHECK_IN_STATUS_UPDATE_ERROR'
};
...
const normalTypes = {
  ...
  APPLICATION_FORM_ERROR_MESSAGES_UPDATE:
    '@@/hacker/APPLICATION_FORM_ERROR_MESSAGES_UPDATE',
...
const normalActionCreators = {
  ...
  applicationPageUpdate: (data) => ({
    type: actionTypes.APPLICATION_PAGE_UPDATE,
    data
  }),
  applicationFormErrorMessagesUpdate: (data) => ({
    type: actionTypes.APPLICATION_FORM_ERROR_MESSAGES_UPDATE,
    data
  }),
  applicationError: (data) => ({ type: actionTypes.APPLICATION_ERROR, data }),
  clearDashboardSuccessMessage: (data) => ({
    type: actionTypes.CLEAR_DASHBOARD_SUCCESS_MESSAGE,
    data
  }),
  clearDashboardErrorMessage: (data) => ({
    type: actionTypes.CLEAR_DASHBOARD_ERROR_MESSAGE,
    data
  }),
  setTestEmailRecipients: (data) => ({
    type: actionTypes.SET_TEST_EMAIL_RECIPIENTS,
    data
  }),
  setReviewTablePage: (data) => ({
    type: actionTypes.SET_REVIEW_TABLE_PAGE,
    data
  }),
  setHackerIDToCheckIn: (data) => ({
    type: actionTypes.SET_HACKER_ID_TO_CHECK_IN,
    data
  })
};
...
const invokeAPIActionCreators = {
  ...
  refresh: (refreshToken) => ({
    ...
    data: {
      types: [
        ...
        actionTypes.TOKENS_REFRESHED,
        actionTypes.INVOKE_API_FAIL
      ],
      request: {
  ...
  createResetHash: (email) => ({
    ...
    data: {
      types: [
        actionTypes.CREATE_RESET_HASH,
        actionTypes.CREATE_RESET_HASH_SUCCESS,
        actionTypes.CREATE_RESET_HASH_FAIL
      ],
      request: {
  ...
  updatePasswordForReset: (resetHash, newPassword) => ({
    ...
    data: {
      types: [
        actionTypes.UPDATE_PASSWORD_RESET,
        actionTypes.UPDATE_PASSWORD_RESET_SUCCESS,
        actionTypes.UPDATE_PASSWORD_RESET_FAIL
      ],
      request: {
  ...
  fetchSettings: () => ({
    ...
    data: {
      types: [
        ...
        actionTypes.SETTINGS_FETCHED,
        actionTypes.SETTINGS_FETCH_ERROR
      ],
      request: {
  ...
  fetchApplicationsWithReviews: (options) => ({
    ...
    data: {
      ...
      request: {
        url: `${API_SUFFIX}${APPLICATIONS_WITH_REVIEWS_ENDPOINT}?${queryString.stringify(
          options
        )}`,
        method: GET,
        tokenRequired: true
