...
export const selectors = {
  ...
  getApplicationFormErrorMessages: (state) =>
    state[reducerMount].applicationFormErrorMessages,
  getIsPasswordResetError: (state) => state[reducerMount].isPasswordResetError,
  getIsPasswordUpdatedError: (state) =>
    state[reducerMount].isPasswordUpdatedError,
  getIsPasswordUpdatedLoading: (state) =>
    state[reducerMount].isPasswordUpdatedLoading,
  getIsPasswordResetLoading: (state) =>
    state[reducerMount].isPasswordResetLoading,
  ...
  getDashboardSuccessMessages: (state) =>
    state[reducerMount].dashboardSuccessMessages,
  getDashboardErrorMessages: (state) =>
    state[reducerMount].dashboardErrorMessages,
  getApplicationsWithReviews: (state) =>
    state[reducerMount].applicationsWithReviews,
  getApplicationsWithReviewsCount: (state) =>
    state[reducerMount].applicationsWithReviewsCount,
  ...
  getHackersRequiringCheckIn: (state) =>
    state[reducerMount].hackersRequiringCheckIn,
  getHackerIDToCheckIn: (state) => state[reducerMount].hackerIDToCheckIn,
  getAreHackersRequiringCheckInLoading: (state) =>
    state[reducerMount].areHackersRequiringCheckInLoading,
  getIsHackerBeingCheckedIn: (state) =>
    state[reducerMount].isHackerBeingCheckedIn
};
